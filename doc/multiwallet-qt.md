...
In order to support loading of multiple wallets in marco-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is marco.cpp.
...
Changes to marco.cpp
----------------------
marco.cpp is the entry point into marco-qt, and as such, will require some minor modifications to provide hooks for
