...
RESOURCES += src/qt/marco.qrc src/qt/marco_locale.qrc

TRANSLATIONS += src/qt/locale/marco_bg.ts \
                src/qt/locale/marco_de.ts \
                src/qt/locale/marco_en.ts \
                src/qt/locale/marco_es.ts \
                src/qt/locale/marco_fi.ts \
                src/qt/locale/marco_fr.ts \
                src/qt/locale/marco_it.ts \
                src/qt/locale/marco_ja.ts \
                src/qt/locale/marco_pl.ts \
                src/qt/locale/marco_pt.ts \
                src/qt/locale/marco_ru.ts \
                src/qt/locale/marco_sk.ts \
                src/qt/locale/marco_sv.ts \
                src/qt/locale/marco_vi.ts \
                src/qt/locale/marco_zh_CN.ts \
                src/qt/locale/marco_zh_TW.ts
