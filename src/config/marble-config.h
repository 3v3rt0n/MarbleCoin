/* src/config/marble-config.h.  Generated from marble-config.h.in by configure.  */
/* src/config/marble-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef MARCO_CONFIG_H

#define MARCO_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.marble.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Marble Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Marble Core 1.2.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "marble"
