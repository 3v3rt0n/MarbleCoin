                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Marco from zMarco"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zMarco"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zMarco));
