...
/** Utility functions used by the Marco Qt UI.
 */
namespace GUIUtil
{
...
// Render Marco addresses in monospace font
...
// Parse "marco:" URI into recipient object, return true on successful parsing
