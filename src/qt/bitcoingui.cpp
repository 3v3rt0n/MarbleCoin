                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Marco Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Marco address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and marco: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Marco Core"), this);
    aboutAction->setStatusTip(tr("Show information about Marco Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Marco"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Marco addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Marco addresses"));
    ...
    openAction->setStatusTip(tr("Open a Marco: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Marco Core help message to get a list with possible Marco command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Marco Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Marco network", "", count));
}
...
{
    QString strTitle = tr("Marco Core"); // default title
...
/** Creates context menu, its actions, and marcos up all the relevant signals for mouse events. */
